            ...
            <table class="table table-hover">
                ...
                <% int x=1; for(Product ob:plist){%>
                    <tr>
                        ...
                        <td><%=ob.getPrice()%></td>
                        <td><%
                                int cid=ob.getCategory();
                                Category cate=cdao.get(cid);
                            %> 
                            <%=cate.getCateName()%>
                        </td>
                        <td><%
                                int sid=ob.getSubcategory();
                                SubCategory subcate=sdao.get(sid);
                            %>
                            <%=subcate.getSubcateName()%>
                        </td>
                        <td><%=ob.isIsActive()?"Active":"Inactive"%></td>
                        <td> 
                            <a href="flipstatus.jsp?pid=<%=ob.getProdId()%>">
                                <b class='btn btn-info'>Flip</b>
                            </a>
                        </td>
                    </tr>
                <% x++; } %>      
